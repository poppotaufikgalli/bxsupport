import { getCurrentInstance, reactive, toRef, isRef, inject, version, defineComponent, computed, ref, h, resolveComponent, nextTick, shallowRef, isReadonly, readonly, unref, Transition, Suspense, provide, useSSRContext, withCtx, createVNode, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/api-routes-efa21065.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index-3a356d61.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/globally-6e9ce824.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/locally-dd7b0ce6.js").then((m) => m.default || m)
  }
];
...
const getRequestURL = (includePath = true) => {
  var _a;
  return _getURL((_a = useRequestEvent()) == null ? void 0 : _a.node.req, includePath);
};
...
const layouts = {
  default: () => import("./_nuxt/default-d0198960.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component-94ee1378.js").then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import("./_nuxt/island-renderer-3a357bad.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
