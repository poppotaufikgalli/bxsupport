import { _ as _export_sfc, d as useSession, u as useRuntimeConfig, b as useNuxtApp } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const msg = ref("");
    [__temp, __restore] = withAsyncContext(() => getProviders()), __temp = await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => getCsrfToken()), __temp = await __temp, __restore();
    [__temp, __restore] = withAsyncContext(() => getToken2()), __temp = await __temp, __restore();
...
//# sourceMappingURL=index-3a356d61.mjs.map
