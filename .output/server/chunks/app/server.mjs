import { getCurrentInstance, version, readonly, defineComponent, h, inject, computed, unref, Suspense, nextTick, Transition, provide, reactive, ref, resolveComponent, shallowRef, isReadonly, useSSRContext, createApp, toRef, isRef, defineAsyncComponent, onErrorCaptured, onServerPrefetch, withCtx, createVNode } from 'vue';
...
const __nuxt_page_meta$3 = { auth: false };
const __nuxt_page_meta$2 = { auth: false };
const __nuxt_page_meta$1 = {};
const __nuxt_page_meta = { auth: false };
const _routes = [
  {
    name: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.name) ?? "api-routes",
    path: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.path) ?? "/api-routes",
    children: [],
    meta: __nuxt_page_meta$3,
    alias: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.alias) || [],
    redirect: (__nuxt_page_meta$3 == null ? void 0 : __nuxt_page_meta$3.redirect) || void 0,
    component: () => import('./_nuxt/api-routes-efa21065.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-3a356d61.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) ?? "protected-globally",
    path: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) ?? "/protected/globally",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_nuxt/globally-6e9ce824.mjs').then((m) => m.default || m)
  },
  {
    name: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) ?? "protected-locally",
    path: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) ?? "/protected/locally",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./_nuxt/locally-dd7b0ce6.mjs').then((m) => m.default || m)
  }
];
...
const authMiddleware = defineNuxtRouteMiddleware((to) => {
  ...
  return signIn2(void 0, { callbackUrl: to.path, error: "SessionRequired" });
});
const plugin_AOuQ1DYzjk = defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
...
const layouts = {
  default: () => import('./_nuxt/default-d0198960.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component-94ee1378.mjs').then((r) => r.default || r));
    const IslandRendererer = defineAsyncComponent(() => import('./_nuxt/island-renderer-3a357bad.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, __nuxt_component_0$1 as a, useNuxtApp as b, createError as c, useSession as d, entry$1 as default, __nuxt_component_1 as e, useRuntimeConfig as u };
